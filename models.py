...
class Todo:
    ...
    def do_action(self,query,old_title=None, new_title=None,new_description=None,new_piority=None):
        cur.execute(query, (new_title,new_description, new_piority, old_title))
    @classmethod
    def load():
